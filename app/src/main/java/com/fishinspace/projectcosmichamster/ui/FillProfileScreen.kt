...
fun FillProfileScreen()
{
        ...
        horizontalAlignment = Alignment.CenterHorizontally)
    {
        ...
        {
            Text(text = "choose a ${fieldNames[fieldIndex]}.", modifier = Modifier, fontFamily = bison,
        ...
        Row(horizontalArrangement = Arrangement.Center, modifier = Modifier
            ...
            .padding(top = 16.dp))
        {
            Text(text = fieldNames[fieldIndex], modifier = Modifier.alpha(0.5f), fontFamily = bison,
                fontWeight = FontWeight.SemiBold, letterSpacing = 1.sp, fontSize = 18.sp)
        }
        ...
        Row(modifier = Modifier.fillMaxWidth(0.7f))
        {
            ...
            ElevatedButton(onClick = {
                ...
                if(value.isNotEmpty())
                {
                    appViewModel.setEdit(fieldNames[fieldIndex], value)
                    if(fieldNames[fieldIndex]=="bio")
                    {
                    ...
                    Toast.makeText(activityContext ,"No ${fieldNames[fieldIndex]} entered.", Toast.LENGTH_SHORT).show()
                }
            }, modifier = Modifier
                .fillMaxWidth(0.7f).padding(start = 2.dp)
                .padding(bottom = 32.dp),
            )
            {
